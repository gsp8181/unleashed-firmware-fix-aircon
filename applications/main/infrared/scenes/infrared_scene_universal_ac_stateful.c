...
void infrared_scene_universal_ac_stateful_on_enter(void* context) {
    ...
    infrared_brute_force_set_db_filename(brute_force, EXT_PATH("infrared/assets/ac_stateful.ir"));
...
bool infrared_scene_universal_ac_stateful_on_event(void* context, SceneManagerEvent event) {
    return infrared_scene_universal_common_on_event(context, event);
}

void infrared_scene_universal_ac_stateful_on_exit(void* context) {
